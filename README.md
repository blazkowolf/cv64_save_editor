...
The following files are supported for opening and then saving. However, at the moment there's no support for saving brand new files of these formats using the `Save As...` option:
* `.mpk` / `.pak` / `.n64` / `.t64`: Controller Pak data.

## Development
This project was developed in C / C++ using [Qt Creator](https://www.qt.io/product/development-tools), more specifically:
```
Qt Creator 15.0.1
